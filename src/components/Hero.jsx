...
// import nexusDesignImg from "../assets/nexusdesign.jpeg";

// const slides = [
//   { label: "01", image: nexusDesignImg, standalone: true },
//   { eyebrow: "Interior Design", title: <>Perfect harmony of<br /><span className="text-brass">flair and function.</span></>, copy: "Considered spaces designed around how you live, work and feel every day.", action: "View interior projects", to: "/projects", label: "02", image: "/images/hero/interior.png" },
//   { eyebrow: "Architecture", title: <>Architecture with<br /><span className="text-brass">purpose and presence.</span></>, copy: "From first concept to construction documentation, every line has a reason.", action: "Explore architecture", to: "/services", label: "03", image: "/images/hero/architecture.png" },
//   { eyebrow: "IT & Technology", title: <>Smart spaces, built<br />to <span className="text-brass">perform.</span></>, copy: "Technology is planned into the space from the start — connected, discreet and reliable.", action: "Explore technology", to: "/services", label: "04", image: "/images/hero/technology.png" },
// ];
...
//   if (slide.standalone) {
//     return (
//       <section className="hero relative overflow-hidden bg-charcoal">
//         <img src={slide.image} alt="" className="w-full h-auto block" />
//         <div className="hero__controls max-w-7xl mx-auto px-4 sm:px-8 py-6 relative z-10 flex items-center justify-between gap-4">
...
export default function Hero() {
  return (
    <section className="hero relative overflow-hidden bg-charcoal">
      <img src={nexusDesignImg} alt="Nexus Design & Built" className="w-full h-auto block" />
    </section>
  );
}